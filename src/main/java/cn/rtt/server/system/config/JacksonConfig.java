...
public class JacksonConfig {
    ...
    public ObjectMapper getObjectMapper(Jackson2ObjectMapperBuilder builder) {
        ...
        javaTimeModule.addSerializer(new LocalTimeSerializer(DateTimeFormatter.ofPattern("HH-mm-ss")));
        javaTimeModule.addSerializer(new LocalDateSerializer(DateTimeFormatter.ofPattern("yyyy-MM-dd")));
        javaTimeModule.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern("yyyy年MM月dd日")));
